...
//         <meta property="og:url" content="https://lovekumar.vercel.app/projects" />
...
const ProjectsSection = () => {
  const [visibleCount, setVisibleCount] = useState(6); // Show first 6 projects initially
    ...
    <>
      <Helmet>
        ...
        <meta
          ...
          content="Portfolio projects built with React, Node.js, MongoDB, and more."
        />
        <meta property="og:image" content="/images/image.png" />
        <meta
          property="og:url"
          content="https://lovekumar.vercel.app/projects"
        />
        <meta property="og:type" content="website" />
        ...
        {visibleCount < projects.length && (
          <div className="flex justify-center mt-12">
            <button
              ...
              className="px-6 py-3 border-2 cursor-pointer border-black font-mono bg-yellow-400 shadow-[4px_4px_0_0_#000] hover:bg-white"
            >
              Load More Projects
            </button>
          </div>
