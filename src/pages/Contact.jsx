...
const Contact = () => {
  ...
  return (
    <>
      <Helmet>
        {/* PRIMARY SEO */}
        <title>Contact | Love Kumar | MERN Stack Developer</title>

        <meta
          name="description"
          content="Get in touch with Love Kumar for web development projects, freelance work, collaborations, and MERN stack opportunities. Contact via form, email, or social platforms."
        />

        <meta
          name="keywords"
          content="Contact Love Kumar, MERN Developer Contact, React Developer India, Full Stack Developer Contact, Freelance Web Developer, Portfolio Contact"
        />
        ...
        {/* CANONICAL */}
        <link rel="canonical" href="https://lovekumar.vercel.app/contact" />

        {/* OPEN GRAPH */}
        <meta
          property="og:title"
          content="Contact | Love Kumar | MERN Stack Developer"
        />

        <meta
          property="og:description"
          content="Contact Love Kumar for MERN stack projects, freelance work, logistics websites, and collaboration opportunities."
        />
        ...
        <meta
          property="og:url"
          content="https://lovekumar.vercel.app/contact"
        />
        ...
        <meta name="twitter:title" content="Contact | Love Kumar" />

        <meta
          name="twitter:description"
          content="Reach out to Love Kumar for web development projects, freelance work, and collaborations."
        />
          ...
          <div className="space-y-8">
            <div className="border-2 border-black p-6 flex items-center justify-between gap-6 shadow-[6px_6px_0_0_#000] max-w-full">
              <div className="flex-1 min-w-0">
                <p className="font-mono text-xs mb-2 text-blue-600">
                  DIRECT_EMAIL
                </p>
                <a
            ...
            <div>
              ...
              <p className=" text-xs mb-4 text-gray-600">
                Feel free to connect — I’m always open to opportunities &
                collaboration.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  >
                    <span>{item.name}</span>
                    <span className="border-2 border-black p-1 text-xl flex items-center justify-center">
                      {item.icon}
                    </span>
                  </a>
                ))}
